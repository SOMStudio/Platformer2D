...
public class BaseGameController : MonoBehaviour
{
	...
	//[TextArea()] public string varStrBig; //tree-line area for edit string def or set size in parameter
	//[Multiline()] public string varStrMlt; //tree-line area for edit multilayer string or set size parameter
	//[SerializeField] private int varIntPrivate; //Show hidden parameter in editor (and rule for edit parameter)
	//[HideInInspector] public int varIntPublic; //Hide in editor the public parameter
